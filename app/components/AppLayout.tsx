  ...
  return (
    <div>
      ...
      <div className="relative flex h-dvh flex-col md:flex-row md:overflow-hidden">
        ...
        <div
          className={`flex w-full flex-col ${fullWidthChat ? 'md:w-full' : 'md:w-1/3'} ${mobilePreviewShown ? 'hidden md:flex md:h-full' : 'h-full'
        ...
        <div
          className={`flex w-full flex-col ${fullWidthChat ? 'md:w-0' : 'md:w-2/3'} ${mobilePreviewShown ? 'h-full' : 'h-auto overflow-visible opacity-100 md:h-full'
            } relative z-10 transition-all duration-300 ease-in-out`}
        >
          <div
